...
with open(path, newline='') as csvfile: csvreader = csv.reader(csvfile, delimiter=',')
    ...
    for row in csvreader:
    	...
    	else: candidates_names_and_votes[row[2]] +=1
    	for v in candidates_names_and_votes.values():percent_vote.append(round(int(v)*100/len(total_votes))).
